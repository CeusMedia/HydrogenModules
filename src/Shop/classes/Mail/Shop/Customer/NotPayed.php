...
class Mail_Shop_Customer_NotPayed extends Mail_Shop_Abstract
{
	/**
	 *	@return		static
	...
	{
		try{
			$templateFile	= 'mail/shop/customer/not_payed.html';
	...
	{
		try{
			$templateFile	= 'mail/shop/customer/not_payed.txt';
