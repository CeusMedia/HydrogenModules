...
//		$mailData['config']		= $this->env->getConfig()->getAll();
	...
	{
		return $this->loadContentFile( 'mail/provision/customer/license/expired.html', $data ) ?? '';
	}
	...
	{
		return $this->loadContentFile( 'mail/provision/customer/license/expired.txt', $data ) ?? '';
	}
}
