...
$form			= HtmlTag::create( 'form', [
	HtmlTag::create( 'div', [
		HtmlTag::create( 'div', [
			...
			HtmlTag::create( 'select', $optProvider, [
				'name'			=> 'providerKey',
...
[$textTop, $textInfo, $textBottom] = array_values( $view->populateTexts( ['top', 'info', 'bottom'], 'html/admin/oauth2/add/' ) );
