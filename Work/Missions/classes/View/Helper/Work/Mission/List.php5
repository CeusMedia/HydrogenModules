...
class View_Helper_Work_Mission_List extends View_Helper_Work_Mission_Abstract{
	...
	public function renderDayList( $tense, $day, $showStatus = FALSE, $showPriority = FALSE, $showDate = FALSE, $showActions = FALSE ){
		...
		$tableBody		= UI_HTML_Tag::create( 'tbody', $this->renderRows( $day, $showStatus, $showPriority, $showDate, $showActions && $tense ) );
	...
	public function renderRows( $day, $showStatus, $showPriority, $showDate, $showActions ){
		$list	= array();
