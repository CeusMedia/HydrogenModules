		...
		<form action="./work/billing/corporation/edit/'.$corporation->corporationId.'" method="post" class="form-changes-auto">
			<div class="row-fluid">
				...
				<div class="span2">
					...
					<input type="text" name="balance" id="input_balance" class="span10 input-number" disabled="disabled" data-max-precision="2" value="'.number_format( $corporation->balance, 2 ).'"/><span class="suffix">&euro;</span>
				</div>
			</div>
			<div class="buttonbar">
				'.$buttonCancel.'
