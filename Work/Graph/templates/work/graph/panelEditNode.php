...
<!--			<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<input type="text" name="width" id="input_width" class="span12" value="'.htmlentities( $node->width, ENT_QUOTES, 'UTF-8' ).'"/>
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<label for="input_height">Height factor <small class="muted">(default: 0.5, try: 0)</small></label>
					<input type="text" name="height" id="input_height" class="span12" value="'.htmlentities( $node->height, ENT_QUOTES, 'UTF-8' ).'"/>
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<label for="input_fontsize">Font size <small class="muted">(default: 14, try: 12)</small></label>
					<input type="text" name="fontsize" id="input_fontsize" class="span12" value="'.htmlentities( $node->fontsize, ENT_QUOTES, 'UTF-8' ).'"/>
				</div>
			</div>
