...
<div class="content-panel content-panel-form">
	...
	<div class="content-panel-inner">
		<form action="./manage/catalog/provision/product/add" method="post">
			<div class="row-fluid">
				<div class="span5">
			...
			<div class="buttonbar">
				...
				<button type="submit" name="save" class="btn btn-primary"><i class="icon-ok icon-white"></i>&npsp;'.$w->buttonSave.'</button>
			</div>
		</form>
	</div>
</div>';
