	...
	<div class="span6">
		<div class="content-panel">
			...
			<div class="content-panel-inner form-changes-auto">
				<form action="manage/catalog/bookstore/category/add/'.htmlentities( $category->parentId, ENT_QUOTES, 'UTF-8' ).'" method="post">
					...
					<div class="buttonbar">
<!--						<a class="btn btn-small" href="./manage/catalog/bookstore/category"><i class="icon-arrow-left"></i> '.$w->buttonCancel.'</a>-->
