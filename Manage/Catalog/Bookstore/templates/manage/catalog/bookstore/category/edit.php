...
$tabs       = array();
$panes      = array(
	'details'	=> $this->loadTemplateFile( 'manage/catalog/bookstore/category/edit.details.php', array( 'w' => $w ) ),
	'articles'	=> $this->loadTemplateFile( 'manage/catalog/bookstore/category/edit.articles.php', array( 'w' => $w ) ),
);
