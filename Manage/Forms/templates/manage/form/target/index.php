...
if( count( $targets ) ){
	...
	foreach( $targets as $target ){
		$link	= HtmlTag::create( 'a', $target->title, array( 'href' => './manage/form/target/edit/'.$target->formTransferTargetId ) );
...
$buttonAdd	= HtmlTag::create( 'a', $iconAdd.'&nbsp;hinzufügen', array( 'class' => 'btn btn-success', 'href' => './manage/form/target/add' ) );
