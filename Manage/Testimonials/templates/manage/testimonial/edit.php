...
<div class="content-panel content-panel-form">
	<h3>'.$w->heading.'</h3>
		...
		<form action="./manage/testimonial/edit/'.$testimonial->testimonialId.'" method="post" class="form-changes-auto">
			...
			<div class="row-fluid">
				<div class="span12">
					<label for="input_description">'.$w->labelDescription.' <small class="muted">'.$w->labelDescription_suffix.'</small></label>
			...
			<div class="buttonbar">
				...
				<a href="./manage/testimonial/remove/'.$testimonial->testimonialId.'" class="btn btn-small btn-danger"><i class="icon-remove icon-white"></i> '.$w->buttonRemove.'</a>
			</div>
		</form>
	</div>
</div>';
