...
extract( $view->populateTexts( array( 'authorize.top', 'authorize.bottom' ), 'html/oauth/' ) );

return $textAuthorizeTop.'
<div class="content-panel">
	<div class="content-panel-inner">
		<h3 class="muted">'.$w->heading.'</h3>
