...
if( $mode == 1 ){
	...
	return '
	<form id="form_filter-bugs" name="filterBugs" action="./labs/bug/filter" method="post">
		<fieldset style="position: relative">
			...
			<div class="buttonbar">
				...
				'.UI_HTML_Elements::LinkButton( './labs/bug/filter/reset', $words['indexFilter']['buttonReset'], 'button reset' ).'
				'.UI_HTML_Elements::LinkButton( './labs/bug/filter/mode/0', $words['indexFilter']['buttonCollapse'], 'button less' ).'
			</div>
		</fieldset>
	</form>
	';
	...
	<form id="form_filter-bugs" name="filterBugs" action="./labs/bug/filter" method="post">
		<fieldset style="position: relative">
			...
			<div class="buttonbar">
				'.UI_HTML_Elements::Button( 'filter', $words['indexFilter']['buttonFilter'], 'button filter' ).'
				'.UI_HTML_Elements::LinkButton( './labs/bug/filter/reset', $words['indexFilter']['buttonReset'], 'button reset' ).'
				'.UI_HTML_Elements::LinkButton( './labs/bug/filter/mode/1', $words['indexFilter']['buttonExpand'], 'button more' ).'
			</div>
		</fieldset>
	</form>
	';
