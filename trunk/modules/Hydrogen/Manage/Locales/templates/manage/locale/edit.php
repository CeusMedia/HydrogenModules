...
$buttonCancel	= UI_HTML_Elements::LinkButton( './manage/locale', $w->buttonCancel, 'button cancel' );
$buttonRemove	= UI_HTML_Elements::LinkButton( './manage/locale/remove/'.$fileHash, $w->buttonRemove, 'button remove', $w->buttonRemoveConfirm );
