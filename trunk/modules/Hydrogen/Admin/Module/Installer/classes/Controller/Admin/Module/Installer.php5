<?php
class Controller_Admin_Module_Installer extends CMF_Hydrogen_Controller{							//  @todo	1) inherit from View_Manage_Module after cleanup
...
#		$this->env->getPage()->addThemeStyle( 'site.manage.module.installer.css' );
